...
.form-control:focus {
  ...
  border-color: #909294;
  outline: 0;
  box-shadow: inset 0 1px 2px rgba(0, 0, 0, 0.075), 0 0 0 0.25rem rgba(33, 37, 41, 0.25);
}
...
.form-range:focus::-webkit-slider-thumb {
  box-shadow: 0 0 0 1px #fff, 0 0 0 0.25rem rgba(33, 37, 41, 0.25);
}
...
.btn-check:checked + .btn:focus, .btn-check:active + .btn:focus, .btn:active:focus, .btn.active:focus {
  box-shadow: 0 0 0 0.25rem rgba(33, 37, 41, 0.25), inset 0 3px 5px rgba(0, 0, 0, 0.125);
}
